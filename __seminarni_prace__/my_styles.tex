...
\usepackage{epstopdf}
\usepackage{setspace}
\usepackage{indentfirst}     % odsazení prvního řádku každého odstavce
\usepackage{listings}
\usepackage{titleps}
...
% šířka odsazení prvního řádku každého odstavce -------------------------------
\setlength{\parindent}{1.25cm}
\setlength{\parskip}{0.125cm}

% posouvám abstrakt na začátek stránky ----------------------------------------
\patchcmd{\abstract}{\null\vfil}{}{}{}
...
\pretitle{%
	...
	{\LARGE \bfseries %
		...
		pomocí jazyka \textsf{R} %
	\\ [0.4cm]}
	\rule{\linewidth}{0.5mm} \\ [1.2cm]

	%% autor ------------------------------------------------------------------
	\noindent
	{\Large $\longeq$ 4EK416 Pokročilá ekonometrie $\longeq$} \\ [0.5cm]
	{\Large $\longeq$ seminární práce $\longeq$} \\ [2.5cm]
